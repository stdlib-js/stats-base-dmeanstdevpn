...
```javascript
import dmeanstdevpn from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmeanstdevpn@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dmeanstdevpn/tags). For example,

```javascript
import dmeanstdevpn from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmeanstdevpn@v0.2.2-esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-dmeanstdevpn.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-dmeanstdevpn

[test-image]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-dmeanstdevpn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-dmeanstdevpn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-dmeanstdevpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-dmeanstdevpn/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-dmeanstdevpn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-dmeanstdevpn/main/LICENSE
